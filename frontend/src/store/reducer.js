export const defaultState = {
	...
	Anagram_salad: {
			...
			partAnswer: [" "],
			lessAnswer: [" "],
			audio: "%PUBLIC_URL%/audio/Anagram_salad.mp3",
	},
	Anagram_swimming: {
			title: "Swimming",
			numOfText:  3,
	...
	Connect_sent_however_B: {
		text1: "Most students enjoy reading. ",
		text2: "However, ",
		choice: [
	...
	Anaphora_stateexam: {
		...
		choice: [
			"the moment to take the state exam",
			"the months of studying",
			"the students had come",
		],
		answer:  1,
	...
	Morpho_possession: {
		...
		text2: "?",
		keyword: "possession",
		answer: ["posess", "pozess", "poses", "pozes","POSSESS"],
